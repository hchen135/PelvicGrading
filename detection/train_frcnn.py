...
parser.add_option("-p", "--path", dest="train_path", help="Path to training data.", default="fold3/train/cr3_fp.csv")
...
parser.add_option("--config_filename", dest="config_filename",
                  ...
                  default="fold3/config_cr3_fp.pickle")
#                  default="fold2/config_tr2.pickle")
parser.add_option("--output_weight_path", dest="output_weight_path", help="Output path for weights.",
                  default='fold3/model_cr3_fp.hdf5')
parser.add_option("--input_weight_path", dest="input_weight_path",
                  help="Input path for weights. If not specified, will try to load default weights provided by keras.",
                  default='models/model_cr3_fp.hdf5')
                  #default='models/model_frcnn.hdf5')
#tr 4000 + fp 3000
# cr from tr 4k+2000 + fp3000
...
model_all.compile(optimizer='sgd', loss='mae')#, metrics=[average_precision_at_k(1), average_precision_at_k(2)])
...
for epoch_num in range(num_epochs):
    ...
    while True:
        try:
            ...
            R = roi_helpers.rpn_to_roi(P_rpn[0], P_rpn[1], C, K.image_dim_ordering(), use_regr=True, overlap_thresh=0.8,
                                       max_boxes=300)
